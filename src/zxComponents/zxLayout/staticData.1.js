const data = {
  menuData: [
    { code: '1', name: '组织机构', link: '/', icon: '' },
    { code: '2', name: '用户', link: '/users', icon: '' },
    { code: '3', name: '用户组', link: '/usergroups', icon: '' },
    { code: '4', name: '日志', link: '/logs', icon: '' },
    { code: '5', name: '数据集成', link: '/dataIntegration', icon: '' },
    { code: '6', name: '插件连接', link: '/addOnConnect', icon: '' },
    { code: '7', name: '新增数据资产', link: '/addData', icon: '' },
    { code: '8', name: 'My Job', link: '/myJob', icon: '' },
  ],
  beta1Menu: [
    {
      name: '首页',
    ...
    },
    {
      ...
      children: [
        { name: '数据逻辑关系', path: '/metadataLogic' },
        {
          ...
          path: '/metadataImport',
          // children:[
          //     { name: '查看目标文件', path: '/metadataImport/metadataImportTable'}
          // ]
        },
        ...
        { name: '元数据识别', path: '/metadataRecognition' },
        { name: '非结构化解析', path: '/unstructStand' },
      ],
    },
    {
      name: 'ETL',
    ...
    },
    {
      ...
      children: [
        ...
        { name: '元数据版本管理', path: '/metadataVersionManage' },
      ],
    },
    {
      name: '元数据监控',
